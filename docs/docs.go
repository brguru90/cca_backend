...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/admin_views.GetUserDocSubscriptionsRespStruct"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/admin/user_subscriptions/playlist/": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/admin_views.GetUserPlaylistSubscriptionsRespStruct"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "admin_views.GetUserDocSubscriptionsRespStruct": {
            "type": "object",
            "required": [
                "data",
                "msg",
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/admin_views.StudyMaterialUserUserSubscriptionList"
                    }
                },
                "msg": {
                    "type": "string"
        ...
        "admin_views.GetUserPlaylistSubscriptionsRespStruct": {
            "type": "object",
            "required": [
                "data",
                "msg",
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/admin_views.VideoPlayListUserSubscriptionList"
                    }
                },
                "msg": {
                    "type": "string"
        ...
        "admin_views.StudyMaterialUserUserSubscriptionList": {
            "type": "object",
            "required": [
            ...
            "properties": {
                ...
                "subscriptions": {
                    "$ref": "#/definitions/mongo_modals.SubsequentStudyMaterialUserSubscriptionStruct"
                },
                "user_id": {
                    "type": "string"
                },
        ...
        "admin_views.VideoPlayListUserSubscriptionList": {
            "type": "object",
            "required": [
                "initial_subscription_date",
                "is_enabled",
            ...
            "properties": {
                ...
                "subscriptions": {
                    "$ref": "#/definitions/mongo_modals.SubsequentUserPlaylistSubscriptionStruct"
                },
                "user_id": {
                    "type": "string"
                },
        ...
        "mongo_modals.SubsequentStudyMaterialUserSubscriptionStruct": {
            "type": "object",
            "required": [
                "duration_in_days",
                "subscribed_on"
        ...
        "mongo_modals.SubsequentUserPlaylistSubscriptionStruct": {
            "type": "object",
            "required": [
                "duration_in_days",
                "subscribed_on"
