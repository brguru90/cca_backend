...
func CreateHLS(video_id string, inputFile string, outputDir string, segmentDuration int) (UploadedVideoInfoStruct, error) {
	...
	ffmpegCmd := exec.Command(
		...
		"-map", "[v3out]", "-c:v:2", "libx264", "-profile:v", "baseline", "-preset", "ultrafast", "-tune", "film", "-tune", "fastdecode", "-tune", "zerolatency", "-bufsize:v:2", "10M", "-g", "48", "-sc_threshold", "0", "-keyint_min", "48",
		"-map", "[v4out]", "-c:v:3", "libx264", "-profile:v", "baseline", "-preset", "ultrafast", "-tune", "film", "-tune", "fastdecode", "-tune", "zerolatency", "-bufsize:v:3", "0.5M", "-g", "48", "-sc_threshold", "0", "-keyint_min", "48",
